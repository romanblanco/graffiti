...
<img src="./docs/map.png" width="96%" />

## Features

### Distributed storage

The core of the project are geotagged photos stored in IPFS, meaning they are not stored in a central database, allowing users to only maintain the areas they are interested in. The data will be reachable as long as there is someone sharing them.

### Metadata

The maintained graffiti collection can be described by the users in metadata, specifying OpenStreetMap node and tags for photos.
